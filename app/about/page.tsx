...
const operatingSignals = [
  ...
  "Research-driven artifacts",
  "Implementation-focused outputs",
  "Scoped advisory work",
];
...
export default function AboutPage() {
  return (
    <>
      <PageHeader
        eyebrow="Firm"
        title="Independent, evidence-backed economic systems advisory."
        lede="Universal Ventures operates at the intersection of economic design, market structure, and digital infrastructure."
      />
        ...
        <div className="mx-auto grid max-w-6xl gap-12 px-6 py-20 md:px-10 md:py-24 lg:grid-cols-[0.34fr_0.66fr] lg:px-16">
          <aside className="border border-line bg-surface p-6">
            ...
            <h2 className="mt-8 text-4xl font-semibold leading-none">
              Economic systems operator and researcher.
            </h2>
          ...
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-base leading-7 text-muted">
              ...
              around artifacts that teams can review, challenge, and implement.
            </p>
